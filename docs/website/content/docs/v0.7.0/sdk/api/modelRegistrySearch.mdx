...
`Promise<`[`ModelRegistryEntry[]`](/v0.7.0/sdk/api/modelRegistryGetModel#modelregistryentry)`>` — Matching model entries. See [`modelRegistryGetModel()`](/v0.7.0/sdk/api/modelRegistryGetModel#modelregistryentry) for the `ModelRegistryEntry` shape.
