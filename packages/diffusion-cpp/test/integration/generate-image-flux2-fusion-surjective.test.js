...
safeTest('FLUX2-klein fusion (surjective) — face morphing via feature averaging', { timeout: 1800000, skip }, async (t) => {
  ...
  try {
    ...
    const response = await model.run({
      prompt: 'blend the face of @image1 (von Neumann) and @image2 (Shannon) into one person, merge their facial features equally, average their ages, single unified face, portrait, color photograph, neutral expression',
