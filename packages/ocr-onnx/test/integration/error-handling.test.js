...
test(
  'getImage rejects GIF format with UNSUPPORTED_IMAGE_FORMAT',
  ...
  async function (t) {
    ...
    try {
      ...
      t.is(
        ...
        'Error code should be UNSUPPORTED_IMAGE_FORMAT'
      )
...
test(
  'getImage rejects WebP format with UNSUPPORTED_IMAGE_FORMAT',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
    // WebP: RIFF....WEBP
...
test(
  'getImage rejects TIFF format with UNSUPPORTED_IMAGE_FORMAT',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test('getImage rejects zero-byte file', { timeout: TEST_TIMEOUT }, async function (t) {
  ...
  try {
    ...
    t.is(
      ...
      'Error code should be INVALID_BMP_OR_INSUFFICIENT_DATA'
    )
...
test(
  'getImageFromBmp rejects BMP with incomplete header',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getImageFromBmp rejects BMP with unsupported header size',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
    ...
    try {
      ...
      t.is(
        ...
        'Error code should be UNSUPPORTED_BMP_HEADER_SIZE'
      )
...
test(
  'getImageFromBmp rejects BMP with truncated pixel data',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
    ...
    try {
      ...
      t.is(
        ...
        'Error code should be INVALID_BMP_PIXEL_DATA'
      )
...
test(
  'getImageFromBmp handles negative height (top-down BMP)',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
    const width = 2
...
test(
  'getImage correctly detects JPEG by magic bytes',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getImage correctly detects PNG by magic bytes',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName throws for completely unsupported language list',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName throws for empty language list',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName returns latin for English',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName returns arabic for Arabic',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName returns cyrillic for Russian',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName returns devanagari for Hindi',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName returns bengali for Bengali',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName prioritizes first language in list',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  'getRecognizerModelName handles other script languages',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
    ...
    t.is(
      onnxOcr.getRecognizerModelName(['ch_sim']),
      'zh_sim',
      'Chinese simplified should map correctly'
    )
    t.is(
      onnxOcr.getRecognizerModelName(['ch_tra']),
      'zh_tra',
      'Chinese traditional should map correctly'
    )
  }
)
