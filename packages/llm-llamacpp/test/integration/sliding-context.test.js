...
safeTest(
  'Cached follow-up clears all middle tokens when discard window is exhausted',
  {
    timeout: 900_000,
    skip
  },
  async (t) => {
    ...
    t.ok(
      second.stats.generatedTokens > 0,
      'second run: generated output after full middle token discard'
    )
