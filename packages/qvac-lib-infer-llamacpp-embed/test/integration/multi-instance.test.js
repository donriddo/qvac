...
test('Two embed instances can run inference simultaneously', {
  ...
  try {
    ...
    console.error(error)
    t.fail('Two embed instances can run inference simultaneously: ' + error.message)
  }
})
...
test('Repeated embed load/unload cycles should remain stable', {
  ...
  try {
    ...
    console.error(error)
    t.fail('Repeated embed load/unload cycles should remain stable: ' + error.message)
  }
})
...
test('Unloading one embed instance does not affect another running instance', {
  ...
  try {
    ...
    console.error(error)
    t.fail('Unloading one embed instance does not affect another running instance: ' + error.message)
  }
})
...
test('Multiple embed load/unload cycles on one instance while another processes', {
  ...
  try {
    ...
    console.error(error)
    t.fail('Multiple embed load/unload cycles on one instance while another processes: ' + error.message)
  }
})
